...
python -m video_chatgpt.docvqa_eval_new \
    --model-name /opt/ml/input/data/wrwwang/model/Video_Chatgpt/LLaVA_lightening-7B-v1-1 \
    --projection_path /opt/ml/input/data/wrwwang/model/Video_Chatgpt/video_chatgpt-7B.bin \
    --data_type v3 \
    --gpu_id 5 \
    --dataset_type S95
